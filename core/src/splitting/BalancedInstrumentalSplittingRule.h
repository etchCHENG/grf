...
#ifndef GRF_BALANCEDINSTRUMENTALSPLITTINGRULE_H
#define GRF_BALANCEDINSTRUMENTALSPLITTINGRULE_H
...
class BalancedInstrumentalSplittingRule final: public SplittingRule {
public:
...
#endif //GRF_BALANCEDINSTRUMENTALSPLITTINGRULE_H
